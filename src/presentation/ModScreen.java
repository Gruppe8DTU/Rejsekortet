...
/**
 * This is the control panel that moderators and admins can acess
 * 
 * @author user
 */
public class ModScreen extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		jPanel1.setBorder(javax.swing.BorderFactory
				.createTitledBorder("Administrative options"));
				...
				.setHorizontalGroup(jPanel2Layout
						...
						.add(jPanel2Layout
								...
								.addPreferredGap(
										...
										81, Short.MAX_VALUE).add(jButton2)
								.add(63, 63, 63)));
		jPanel2Layout
		...
		try {
			for (javax.swing.UIManager.LookAndFeelInfo info : javax.swing.UIManager
				...
				if ("Nimbus".equals(info.getName())) {
					System.out
							.println("Warning mod screen running from own main method!");
					javax.swing.UIManager.setLookAndFeel(info.getClassName());
					break;
				}
			}
		} catch (ClassNotFoundException ex) {
			java.util.logging.Logger.getLogger(ModScreen.class.getName()).log(
