...
/*
 * This is the screen where users can report content, but has been extended to be 
 * used for changing user rights as well
 */
...
public class ReportScreen extends JFrame {
	...
	public void setRadioButtonText(String str1, String str2, String str3) {
		...
		rdbtnPic.setText(str2);
		rdbtnDest.setText(str3);
	}
