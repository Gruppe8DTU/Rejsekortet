...
/**
 * This boundary is created with NetBeans so don't look at the autogenerated stuff.
 * It has it's own main method so it can be launched and configured independently of the program
 * @author user
 */
